...
tests = [ {'description': 'This test will run first.',
    ...
    {'description': 'This test will run 6.',
    'steps': [ {'inputs': [('PINA', 0x01)],'iterations': 1},],
    'expected': [('PORTC',0x09)],
    },
    {'description': 'This test will run 7.',
    'steps': [ {'inputs': [('PINA', 0x03)],'iterations': 1},],
    'expected': [('PORTC',0x00)],
    },
    {'description': 'This test	 will run 8.',
    'steps': [ {'inputs': [('PINA', 0x02)],'iterations': 1},],
    'expected': [('PORTC',0x00)],
    },
    {'description': 'This test will run 9.',
    'steps': [ {'inputs': [('PINA', 0x01)],'iterations': 1},],
    'expected': [('PORTC',0x01)],
    },
    {'description': 'This test will run 10.',
    'steps': [ {'inputs': [('PINA', 0x03)],'iterations': 1},],
    'expected': [('PORTC',0x00)],
    },
    ]
